...
if exist_objfield(subj,objtype,objname,'movehd')
  ...
  clear mat
  subj = set_objsubfield(subj,objtype,objname,'movehd','last_saved',datetime_(true),'ignore_absence',true);
...
subj = set_objfield(subj,objtype,objname,'last_modified',datetime_(true),'ignore_absence',true);
